...
func (p *Plugin) getPicURL() string {
	...
	//  success picture url
	pics["success"] = "https://ws4.sinaimg.cn/wap180/006tNc79gy1fz05g5a7utj30he0bfjry.jpg"
	if p.Extra.Pic.SuccessPicURL != "" {
		pics["success"] = p.Extra.Pic.SuccessPicURL
	}
	//  failure picture url
	pics["failure"] = "https://ws1.sinaimg.cn/wap180/006tNc79gy1fz0b4fghpnj30hd0bdmxn.jpg"
